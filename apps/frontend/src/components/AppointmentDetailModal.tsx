          ...
          <div className="flex-1 overflow-hidden flex">
            ...
            <div className="flex-1 p-4 flex flex-col min-w-0">
                ...
                <div className="space-y-2">
                  {appointment.services.map((service, index) => (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-3">
                        <span className="font-bold text-sm">{service.price.toLocaleString('ru-RU')} ₽</span>
                  ...
                  {appointment.products.map((product) => (
                    ...
                    >
                      <div>
                        ...
                        <p className="text-xs text-gray-500">{product.qty} шт × {product.price.toLocaleString('ru-RU')} ₽</p>
                      </div>
                      <span className="font-bold text-sm">{product.total.toLocaleString('ru-RU')} ₽</span>
                    </div>
                  ))}
              ...
              <div className="mt-auto pt-4 border-t border-gray-200">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-2xl font-bold">{appointment.total.toLocaleString('ru-RU')} ₽</span>
                </div>
                {appointment.isPaid && (
            ...
            <div className="w-80 bg-gray-50 border-l border-gray-200 p-4 space-y-4 overflow-y-auto">
              ...
              <div className="bg-white rounded-lg p-4 border border-gray-200">
                ...
                <button className="w-full flex items-center justify-center gap-2 px-3 py-2 bg-gray-100 rounded-lg text-sm text-gray-600 hover:bg-gray-200 transition-colors">
                  <span className="material-symbols-outlined text-sm">history</span>
                  История посещений
                </button>
              </div>
              ...
              <div className="space-y-3">
                <h4 className="text-xs font-medium text-gray-500 uppercase">Данные по сети</h4>
                <div className="grid grid-cols-2 gap-3 text-sm">
                  <div>
                    <p className="text-gray-500">Последний визит</p>
                  ...
                  <div>
                    <p className="text-gray-500">Не пришел</p>
                    <p className="font-medium">-</p>
                  </div>
                  <div>
