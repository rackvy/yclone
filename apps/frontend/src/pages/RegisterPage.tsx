    ...
    <div className="flex min-h-screen items-center justify-center px-4 py-12 sm:px-6 lg:px-8 bg-background-light">
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="bg-white p-8 rounded-xl login-card-shadow border border-gray-100">
          <div className="mb-6">
            <h3 className="text-lg font-semibold text-gray-900">Создать аккаунт</h3>
            <p className="text-sm text-gray-500">Начните бесплатный 14-дневный пробный период</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  id="companyName"
                  name="companyName"
                  placeholder="Салон красоты 'Афродита'"
                  type="text"
                  value={companyName}
            ...
            <div className="flex items-start">
              ...
              <label className="ml-2 block text-sm text-gray-700" htmlFor="agree-terms">
                Я принимаю{' '}
                <a href="#" className="text-primary hover:text-primary/80">условия использования</a>
                {' '}и{' '}
                <a href="#" className="text-primary hover:text-primary/80">политику конфиденциальности</a>
              </label>
            </div>
