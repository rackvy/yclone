...
import { productsApi, productCategoriesApi, stockMovementsApi, Product, ProductCategory } from '../api/products';

type TabType = 'branches' | 'masterRanks' | 'employees' | 'services' | 'products';
